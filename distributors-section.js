...
(function () {
  ...
  section.innerHTML = `
    <div class="max-w-7xl mx-auto px-5 md:px-6">
      ...
      <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-6 items-center">
        ...
        <a href="distributor.html?slug=euroin" class="dist-logo flex items-center justify-center h-20 bg-brand-gray-50 rounded-xl px-4" title="EUROIN, a.s.">
          <img src="Brand/distributors/euroin.png" alt="EUROIN" class="max-h-11 max-w-full object-contain">
        </a>
      </div>
    </div>
  `;
